...
export default function Component() {
    return (
        <div className="flex justify-center min-h-screen items-center">
            <div className="max-w-sm mx-auto my-10 bg-white p-6 rounded-lg shadow-md">
                <div className="flex justify-center">
                    <div
                        className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-green-200 text-2xl font-semibold">
                        2
                    </div>
                </div>
